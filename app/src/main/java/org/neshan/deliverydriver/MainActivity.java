...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnTakeConsignment;
    private Button btnGiveConsignment;
    ...
    protected void onStart() {
        ...
        btnReachedToSource.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                btnTakeConsignment.setVisibility(View.VISIBLE);
                return true;
            }
        });

        btnTakeConsignment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, getString(R.string.long_press_for_accept), Toast.LENGTH_SHORT).show();
            }
        ...
        btnTakeConsignment.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                view.setVisibility(View.GONE);
                btnGiveConsignment.setVisibility(View.VISIBLE);
                return true;
            }
        });

        btnGiveConsignment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, getString(R.string.long_press_for_accept), Toast.LENGTH_SHORT).show();
            }
        ...
        btnGiveConsignment.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                resetRequestWindow();
    ...
    private void resetRequestWindow() {
        ...
        btnGiveConsignment.setVisibility(View.GONE);
    ...
    private void initViews() {
        ...
        btnTakeConsignment = findViewById(R.id.btn_take_consignment);
        btnGiveConsignment = findViewById(R.id.btn_give_consignment);
    ...
    private void addUserMarker(LatLng loc) {
        ...
        markStCr.setBitmap(com.carto.utils.BitmapUtils.createBitmapFromAndroidBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.scooter_small)));
        MarkerStyle markSt = markStCr.buildStyle();
